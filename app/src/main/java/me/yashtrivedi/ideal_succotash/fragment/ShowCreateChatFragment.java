...
public class ShowCreateChatFragment extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.dialog_create_chat,null);
        ...
        firebase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot d : dataSnapshot.getChildren()){
                    adapter.add(Utils.decodeEmail(dataSnapshot.getKey()));
                }
            }
        ...
        .setPositiveButton("Create", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Firebase firebase1 = new Firebase(Constants.FIREBASE_URL_USERS.concat("/").concat(Utils.getMyEmail(getContext()))).push();
                ...
                Firebase firebase2 = new Firebase(Constants.FIREBASE_URL_USERS.concat("/").concat(Utils.encodeEmail(appCompatAutoCompleteTextView.getText().toString())).concat("/").concat(threadID));
                ...
                map1.put(Constants.THREAD_TIME,ServerValue.TIMESTAMP);
                map1.put(Constants.THREAD_UNREAD_COUNT,0);
                firebase2.setValue(map);
            }
        })
